...
export const providerCatalog = [
  ...
  { id: 'mimo', name: 'MiMo', legalName: 'Xiaomi MiMo Token Plan', monogram: 'M', tone: 'coral', adapter: 'mimo', logo: './logos/mimo.svg', website: 'https://platform.xiaomimimo.com' },
...
export const windowCatalog = {
  ...
  mimo_plan: { key: 'mimo_plan', label: '套餐 Credits', short: '积分', group: 'MiMo', color: 'coral' },
